...
export class NodeEventGenerator {
    private nodeEvents: NodeEventCollection = {};
    private nodeTriggers: NodeTriggerCollection = {};
    
    // connect node-event to callback function
    public connect(nodeEvent: string, origin: NodeEventGenerator, callback: (self: NodeEventGenerator, data: Object) => void) {
    ...
    public trigger(nodeEvent: string, data = {}) {
